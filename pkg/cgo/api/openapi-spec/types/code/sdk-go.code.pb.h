...
#ifndef GOOGLE_PROTOBUF_INCLUDED_types_2fsdk_2dgo_2ecode_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_types_2fsdk_2dgo_2ecode_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_types_2fsdk_2dgo_2ecode_2eproto
...
struct TableStruct_types_2fsdk_2dgo_2ecode_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_types_2fsdk_2dgo_2ecode_2eproto;
namespace sdk {
namespace types {
namespace code {
class CgoError;
...
class CgoError PROTOBUF_FINAL :
 ...
 public:
  ...
  inline CgoError* New() const final {
    return CreateMaybeMessage<CgoError>(nullptr);
  }
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_types_2fsdk_2dgo_2ecode_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  void _internal_set_sdk_error_message(const std::string& value);
 ...
 private:
  ...
  friend struct ::TableStruct_types_2fsdk_2dgo_2ecode_2eproto;
};
// ===================================================================
...
inline void CgoError::set_sdk_error_message(const std::string& value) {
  _internal_set_sdk_error_message(value);
...
inline std::string* CgoError::mutable_sdk_error_message() {
  ...
  return _internal_mutable_sdk_error_message();
}
...
inline void CgoError::_internal_set_sdk_error_message(const std::string& value) {
  ...
  sdk_error_message_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void CgoError::set_sdk_error_message(std::string&& value) {
  
  sdk_error_message_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
...
inline void CgoError::set_sdk_error_message(const char* value) {
  ...
  sdk_error_message_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
...
inline void CgoError::set_sdk_error_message(const char* value,
  ...
  sdk_error_message_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* CgoError::_internal_mutable_sdk_error_message() {
  ...
  return sdk_error_message_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* CgoError::release_sdk_error_message() {
  ...
  return sdk_error_message_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_types_2fsdk_2dgo_2ecode_2eproto
