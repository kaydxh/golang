...
#ifndef GOOGLE_PROTOBUF_INCLUDED_gocv_2fgocv_2emagick_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_gocv_2fgocv_2emagick_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_gocv_2fgocv_2emagick_2eproto
...
struct TableStruct_gocv_2fgocv_2emagick_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_gocv_2fgocv_2emagick_2eproto;
namespace sdk {
namespace api {
namespace gocv {
...
class MagickInitializeMagickRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:sdk.api.gocv.MagickInitializeMagickRequest) */ {
 public:
  inline MagickInitializeMagickRequest() : MagickInitializeMagickRequest(nullptr) {}
  ~MagickInitializeMagickRequest() override;
  explicit constexpr MagickInitializeMagickRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline MagickInitializeMagickRequest* New() const final {
    return new MagickInitializeMagickRequest();
  }
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "sdk.api.gocv.MagickInitializeMagickRequest";
  }
  protected:
 ...
 private:
  ...
  friend struct ::TableStruct_gocv_2fgocv_2emagick_2eproto;
};
// -------------------------------------------------------------------

class MagickInitializeMagickResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:sdk.api.gocv.MagickInitializeMagickResponse) */ {
 public:
  inline MagickInitializeMagickResponse() : MagickInitializeMagickResponse(nullptr) {}
  ~MagickInitializeMagickResponse() override;
  explicit constexpr MagickInitializeMagickResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline MagickInitializeMagickResponse* New() const final {
    return new MagickInitializeMagickResponse();
  }
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "sdk.api.gocv.MagickInitializeMagickResponse";
  }
  protected:
  ...
  PROTOBUF_MUST_USE_RESULT ::sdk::types::code::CgoError* release_error();
...
void MagickInitializeMagickRequest::set_path(ArgT0&& arg0, ArgT... args) {
...
inline void MagickInitializeMagickResponse::unsafe_arena_set_allocated_error(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:sdk.api.gocv.MagickInitializeMagickResponse.error)
}
...
inline ::sdk::types::code::CgoError* MagickInitializeMagickResponse::_internal_mutable_error() {
  ...
  if (error_ == nullptr) {
    auto* p = CreateMaybeMessage<::sdk::types::code::CgoError>(GetArenaForAllocation());
    error_ = p;
  }
  return error_;
}
inline ::sdk::types::code::CgoError* MagickInitializeMagickResponse::mutable_error() {
  ::sdk::types::code::CgoError* _msg = _internal_mutable_error();
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_gocv_2fgocv_2emagick_2eproto
