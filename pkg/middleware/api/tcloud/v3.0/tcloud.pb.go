...
// 	protoc        v3.13.0
// source: pkg/middleware/grpc-middleware/api/tcloud/v3.0/tcloud.proto
...
func (x *TCloudBaseRequest) Reset() {
	*x = TCloudBaseRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_middleware_grpc_middleware_api_tcloud_v3_0_tcloud_proto_msgTypes[0]
...
func (*TCloudBaseRequest) Descriptor() ([]byte, []int) {
	return file_pkg_middleware_grpc_middleware_api_tcloud_v3_0_tcloud_proto_rawDescGZIP(), []int{0}
}
...
func (x *TCloudResponse) Reset() {
	*x = TCloudResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_middleware_grpc_middleware_api_tcloud_v3_0_tcloud_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*TCloudResponse) Descriptor() ([]byte, []int) {
	return file_pkg_middleware_grpc_middleware_api_tcloud_v3_0_tcloud_proto_rawDescGZIP(), []int{1}
}
...
func (x *TCloudErrorResponse) Reset() {
	*x = TCloudErrorResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_middleware_grpc_middleware_api_tcloud_v3_0_tcloud_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*TCloudErrorResponse) Descriptor() ([]byte, []int) {
	return file_pkg_middleware_grpc_middleware_api_tcloud_v3_0_tcloud_proto_rawDescGZIP(), []int{2}
}
...
func (x *ErrorResponse) Reset() {
	*x = ErrorResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_middleware_grpc_middleware_api_tcloud_v3_0_tcloud_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ErrorResponse) Descriptor() ([]byte, []int) {
	return file_pkg_middleware_grpc_middleware_api_tcloud_v3_0_tcloud_proto_rawDescGZIP(), []int{3}
}
...
func (x *TCloudError) Reset() {
	*x = TCloudError{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_middleware_grpc_middleware_api_tcloud_v3_0_tcloud_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*TCloudError) Descriptor() ([]byte, []int) {
	return file_pkg_middleware_grpc_middleware_api_tcloud_v3_0_tcloud_proto_rawDescGZIP(), []int{4}
}
...
var File_pkg_middleware_grpc_middleware_api_tcloud_v3_0_tcloud_proto protoreflect.FileDescriptor

var file_pkg_middleware_grpc_middleware_api_tcloud_v3_0_tcloud_proto_rawDesc = []byte{
	0x0a, 0x3b, 0x70, 0x6b, 0x67, 0x2f, 0x6d, 0x69, 0x64, 0x64, 0x6c, 0x65, 0x77, 0x61, 0x72, 0x65,
	0x2f, 0x67, 0x72, 0x70, 0x63, 0x2d, 0x6d, 0x69, 0x64, 0x64, 0x6c, 0x65, 0x77, 0x61, 0x72, 0x65,
	...
	0x01, 0x28, 0x09, 0x52, 0x06, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x1a, 0x39, 0x0a, 0x0b, 0x50,
	...
	0x01, 0x28, 0x09, 0x52, 0x07, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x42, 0x50, 0x5a, 0x4e,
	...
	0x64, 0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x2d, 0x6d, 0x69, 0x64,
	0x64, 0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x74, 0x63, 0x6c, 0x6f,
	0x75, 0x64, 0x2f, 0x76, 0x33, 0x2e, 0x30, 0x3b, 0x74, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x62, 0x06,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_pkg_middleware_grpc_middleware_api_tcloud_v3_0_tcloud_proto_rawDescOnce sync.Once
	file_pkg_middleware_grpc_middleware_api_tcloud_v3_0_tcloud_proto_rawDescData = file_pkg_middleware_grpc_middleware_api_tcloud_v3_0_tcloud_proto_rawDesc
)

func file_pkg_middleware_grpc_middleware_api_tcloud_v3_0_tcloud_proto_rawDescGZIP() []byte {
	file_pkg_middleware_grpc_middleware_api_tcloud_v3_0_tcloud_proto_rawDescOnce.Do(func() {
		file_pkg_middleware_grpc_middleware_api_tcloud_v3_0_tcloud_proto_rawDescData = protoimpl.X.CompressGZIP(file_pkg_middleware_grpc_middleware_api_tcloud_v3_0_tcloud_proto_rawDescData)
	})
	return file_pkg_middleware_grpc_middleware_api_tcloud_v3_0_tcloud_proto_rawDescData
}

var file_pkg_middleware_grpc_middleware_api_tcloud_v3_0_tcloud_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_pkg_middleware_grpc_middleware_api_tcloud_v3_0_tcloud_proto_goTypes = []interface{}{
...
var file_pkg_middleware_grpc_middleware_api_tcloud_v3_0_tcloud_proto_depIdxs = []int32{
...
func init() { file_pkg_middleware_grpc_middleware_api_tcloud_v3_0_tcloud_proto_init() }
func file_pkg_middleware_grpc_middleware_api_tcloud_v3_0_tcloud_proto_init() {
	if File_pkg_middleware_grpc_middleware_api_tcloud_v3_0_tcloud_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_pkg_middleware_grpc_middleware_api_tcloud_v3_0_tcloud_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_middleware_grpc_middleware_api_tcloud_v3_0_tcloud_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_middleware_grpc_middleware_api_tcloud_v3_0_tcloud_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_middleware_grpc_middleware_api_tcloud_v3_0_tcloud_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_middleware_grpc_middleware_api_tcloud_v3_0_tcloud_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_pkg_middleware_grpc_middleware_api_tcloud_v3_0_tcloud_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_middleware_grpc_middleware_api_tcloud_v3_0_tcloud_proto_goTypes,
		DependencyIndexes: file_pkg_middleware_grpc_middleware_api_tcloud_v3_0_tcloud_proto_depIdxs,
		MessageInfos:      file_pkg_middleware_grpc_middleware_api_tcloud_v3_0_tcloud_proto_msgTypes,
	}.Build()
	File_pkg_middleware_grpc_middleware_api_tcloud_v3_0_tcloud_proto = out.File
	file_pkg_middleware_grpc_middleware_api_tcloud_v3_0_tcloud_proto_rawDesc = nil
	file_pkg_middleware_grpc_middleware_api_tcloud_v3_0_tcloud_proto_goTypes = nil
	file_pkg_middleware_grpc_middleware_api_tcloud_v3_0_tcloud_proto_depIdxs = nil
}
