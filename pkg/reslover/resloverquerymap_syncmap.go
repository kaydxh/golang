...
func _() {
	// An "cannot convert ResloverQueryMap literal (type ResloverQueryMap) to type sync.Map" compiler error signifies that the base type have changed.
	// Re-run the go-syncmap command to generate them again.
	_ = (sync.Map)(ResloverQueryMap{})
}

var _nil_ResloverQueryMap_ResloverQuery_value = func() (val ResloverQuery) { return }()
...
func (m *ResloverQueryMap) Load(key string) (ResloverQuery, bool) {
	...
	if value == nil {
		return _nil_ResloverQueryMap_ResloverQuery_value, ok
	}
...
func (m *ResloverQueryMap) LoadOrStore(key string, value ResloverQuery) (ResloverQuery, bool) {
	...
	if actual == nil {
		return _nil_ResloverQueryMap_ResloverQuery_value, loaded
	}
